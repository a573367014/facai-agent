...
const envSchema = z.object({
  ...
  VOLCENGINE_VIDEO_ENDPOINT: z.string().url().default("https://visual.volcengineapi.com"),
  VOLCENGINE_VIDEO_REGION: z.string().default("cn-north-1"),
  VOLCENGINE_VIDEO_SERVICE: z.string().default("cv"),
  VOLCENGINE_VIDEO_VERSION: z.string().default("2022-08-31"),
  VOLCENGINE_VIDEO_REQ_KEY: z.string().default("jimeng_t2v_v30"),
  VOLCENGINE_VIDEO_FIRST_FRAME_REQ_KEY: z.string().default("jimeng_i2v_first_v30"),
  VOLCENGINE_VIDEO_FIRST_LAST_FRAME_REQ_KEY: z.string().default("jimeng_i2v_first_tail_v30"),
  VOLCENGINE_VIDEO_POLL_INTERVAL_MS: z.coerce.number().int().min(0).default(1500),
  VOLCENGINE_VIDEO_MAX_POLL_ATTEMPTS: z.coerce.number().int().min(1).max(240).default(80),
  VOLCENGINE_VIDEO_TOOL_TIMEOUT_MS: z.coerce.number().int().positive().default(600000),
